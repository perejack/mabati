                  ...
                  <div className="bg-gray-50 rounded-lg p-3 md:p-4 mb-6 relative overflow-hidden">
                    ...
                    <div className="mt-6 flex flex-col space-y-3">
                      <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        <a 
                          href={`https://wa.me/254762178314?text=I'm%20interested%20in%20ordering%20${encodeURIComponent(product.title)}%20-%20${encodeURIComponent(product.priceVariants[0].name)}`}
                          target="_blank"
