    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <div className="relative h-96">
          <img 
            src="https://i0.wp.com/regtechafrica.com/wp-content/uploads/2022/05/CAK-penalises-Royal-Mabati-Sh2.6m-for-defrauding-customers.jpg?fit=1100%2C733&ssl=1" 
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
              <div>
                <img 
                  src="https://maishamabati.com/wp-content/uploads/2021/06/slid1-1.jpg" 
              ...
              <div>
                <img 
                  src="https://maishamabati.com/wp-content/uploads/2021/03/IMG_3450-scaled.jpg" 
